...
with DAG(dag_id = "postgres_dag_connection", default_args = default_dag_args, schedule_interval = None, start_date = days_ago(1)) as postgres_dag:
    task_0 = PostgresOperator(task_id = "create_table", sql = create_query, postgres_conn_id = "postgresql_local") 
    task_1 = PostgresOperator(task_id = "insert_data", sql = insert_data_query, postgres_conn_id = "postgresql_local")
    task_2 = PostgresOperator(task_id = "group_data", sql = create_grouped_table, postgres_conn_id = "postgres_local")
